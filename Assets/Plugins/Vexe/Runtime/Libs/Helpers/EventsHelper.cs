...
namespace Vexe.Runtime.Helpers
{
	public static class EventsHelper
	{
		...
		public static Event GetLMBMouseDownEvent()
		{
			return new Event { type = EventType.MouseDown, keyCode = KeyCode.Mouse0 };
		}
		...
		public static bool IsMMB()
		{
			return Event.current.button == 2;
		}

		public static bool IsLMBMouseDown()
		{
			return IsMouseDown() && IsLMB();
		}

		public static bool IsRMBMouseDown()
		{
			return IsMouseDown() && IsRMB();
		}

		public static bool IsMMBMouseDown()
		{
			return IsMouseDown() && IsMMB();
		}
	}
}
