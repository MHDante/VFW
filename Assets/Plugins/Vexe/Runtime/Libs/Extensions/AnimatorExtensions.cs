...
namespace Vexe.Runtime.Extensions
{
	...
	{
		public static void Bools(this Animator animator, string name, bool value)
		{
			animator.SetBool(name, value);
		}

		public static bool Bools(this Animator animator, string name)
		{
			return animator.GetBool(name);
		}

		public static void Floats(this Animator animator, string name, float value)
		{
			animator.SetFloat(name, value);
		}

		public static float Floats(this Animator animator, string name)
		{
			return animator.GetFloat(name);
		}

		public static void Ints(this Animator animator, string name, int value)
		{
			animator.SetInteger(name, value);
		}

		public static int Ints(this Animator animator, string name)
		{
