...
namespace Vexe.FastSave.Serializers
{
	public class ReflectiveComponentSerializer : ReflectiveSerializer
	{
		...
		private static void SerializeComponentReference(Stream stream, Component value)
		{
			if (value == null)
			{
		...
		private static Component DeserializeComponentReference(Stream stream, Type type)
		{
