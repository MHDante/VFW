...
namespace BX20Serializer
{
	...
	public class CollectionSerializer : BaseSerializer
	{
		...
		private static object[] addArgs = new object[1];
		...
		private static Dictionary<Type, MethodInfo> _ClearMethods =
		   new Dictionary<Type, MethodInfo>();

		private static Dictionary<Type, MethodInfo> _AddMethods =
		   new Dictionary<Type, MethodInfo>();

		private static MethodInfo GetAddMethod(Type collection, Type element)
		{
			MethodInfo result;
		...
		private static MethodInfo GetClearMethod(Type collection)
		{
			MethodInfo result;
		...
		private static MethodInfo GetAddMethod(Type collection, Type element, string methodName)
		{
