	...
	public static class FSCommon
	{
		...
		static FSCommon()
		{
			...
			ecs.Add<Transform>("position", "eulerAngles", "localScale")
			   ...
			   .Add<ParticleSystem>("emissionRate", "enableEmission", "gravityModifier", "loop", "maxParticles", "playbackSpeed", "playOnAwake", "randomSeed", "scalingMode", "simulationSpace", "startColor", "startDelay", "startLifetime", "startRotation", "startRotation3D", "startSize", "startSpeed", "time")
