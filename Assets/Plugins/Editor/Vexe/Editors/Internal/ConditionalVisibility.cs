...
namespace Vexe.Editor.Internal
{
	...
	{
		private static Dictionary<MemberInfo, MethodCaller<object, bool>> _isVisibleCache = new Dictionary<MemberInfo, MethodCaller<object, bool>>();
		...
		private static bool AlwaysVisible(object target, object[] args)
		{ return true; }
	}
}
