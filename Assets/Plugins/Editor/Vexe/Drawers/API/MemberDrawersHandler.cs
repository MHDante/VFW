...
namespace Vexe.Editor
{
	...
	{
		private static readonly Dictionary<int, List<BaseDrawer>> _cachedCompositeDrawers;
		private static readonly Dictionary<int, BaseDrawer> _cachedMemberDrawers;
		private static readonly Dictionary<int, MethodDrawer> _cachedMethodDrawers;
