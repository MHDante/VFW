...
namespace Vexe.Editor.Visibility
{
	public static class VisibilityLogic
	{
		...
		private static readonly Func<Type, List<MemberInfo>> _cachedGetDefaultVisibleMembers;
		...
		private static HashSet<string> IgnoredUnityProperties = new HashSet<string>()
		{
