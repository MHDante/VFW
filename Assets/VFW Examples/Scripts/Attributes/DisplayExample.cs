...
namespace VFWExamples
{
	...
	public class DisplayExample : BaseBehaviour
	{
		...
		private string FormatArrayElement(Component value)
		{
			return value == null ? "Null" : value.GetType().GetNiceName();
		}

		[Serializable]
		public class Lookup : SerializableDictionary<string, Transform> { }
	}
	...
	public struct DisplayOrderExample
	{
		...
		public struct Five
		{
			...
			[Display]
			public Color eight; // if no order is specified the member will be drawn in the remaining order
